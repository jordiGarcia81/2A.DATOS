...
namespace AE2.Models
{
    public class UsuarioRepository
    {
        ...
        {
            string conectString = ("server=127.0.0.1;port=3306;database=placemybet;uid=root;pwd=;Convert Zero Datetime =True;Convert Zero Datetime =True;");
        ...
        //            u = new UsuarioDTO( res.GetString(1), res.GetString(2), res.GetInt16(3));
        //            usuarios.Add(u);
        //        }
        //        con.Close();
        //        return usuarios;
